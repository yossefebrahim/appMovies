...
class MainTopRatedTvScreen extends StatelessWidget {
  const MainTopRatedTvScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
        create: (BuildContext context) =>
            sl<TvBloc>()..add(GetTopRatesTvEvent()),
        child: Scaffold(
...
class TopRatedTvScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<TvBloc, TvState>(builder: (context, state) {
      return switch (state.topRatedTvState) {
