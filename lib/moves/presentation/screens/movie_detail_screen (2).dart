...
class MovieDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (BuildContext context) => sl<MovieDetaliesBloc>()
        ..add(GetMovieDetaliesEvent(id))
        ..add(GetMovieDetaliesRecomandationEvent(id)),
      lazy: false,
      child: Scaffold(
...
class MovieDetailContent extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return BlocBuilder<MovieDetaliesBloc, MovieDetaliesState>(
      builder: (context, state) {
        return switch (state.movieDetaliesState) {
                      ...
                      child: ShaderMask(
                        ...
                        child: CachedNetworkImage(
                          ...
                          imageUrl: ApiConstance.imageUrl(
                              state.movieDetalies!.backdropPath),
                          fit: BoxFit.cover,
                        ),
                      ),
                    ),
                  ...
                  child: FadeInUp(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(state.movieDetalies!.title,
                          ...
                          Row(
                            children: [
                              Container(
                                ...
                                child: Text(
                                  state.movieDetalies!.releaseDate
                                      .split('-')[0],
                              ...
                              Row(
                                children: [
                                  ...
                                  Text(
                                    (state.movieDetalies!.voteAverage / 2)
                                        .toStringAsFixed(1),
                                    style: const TextStyle(
                                      fontSize: 16.0,
                                      fontWeight: FontWeight.w500,
                                  ...
                                  const SizedBox(width: 4.0),
                                  Text(
                                    '(${state.movieDetalies!.voteAverage})',
                                    style: const TextStyle(
                                      fontSize: 1.0,
                                      fontWeight: FontWeight.w500,
                                      letterSpacing: 1.2,
                              ...
                              const SizedBox(width: 16.0),
                              Text(
                                _showDuration(state.movieDetalies!.runTime),
                                style: const TextStyle(
                          ...
                          const SizedBox(height: 8.0),
                          Text(
                            'Genres: ${_showGenres(state.movieDetalies!.genres)}',
                            style: const TextStyle(
                              color: Colors.white70,
                              fontSize: 12.0,
                              fontWeight: FontWeight.w500,
          ...
          RequestState.loading => SizedBox(
              child: Text(state.movieDetaliesMessage),
            ),
        };
      },
    );
      ...
      builder: (context, state) {
        return SliverGrid(
          delegate: SliverChildBuilderDelegate(
            (context, index) {
              final recommendation = state.recomandation[index];
              return FadeInUp(
                from: 20,
                duration: const Duration(milliseconds: 500),
                child: ClipRRect(
            ...
            childCount: state.recomandation.length,
          ),
